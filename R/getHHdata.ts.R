...
#' @details Surveys available in DATRAS: i.e. SWC-IBTS,SCOWCGFS,SCOROC, ROCKALL, NIGFS, IE-IGFS, SP-PORC, FR-CGFS, EVHOE, SP-NORTH, PT-IBTS, SP-ARSA and recently include also NS-IBTS
#' @examples getHHdata.ts("SWC-IBTS",c(2014:2016),1)
#' @export
   getHHdata.ts<-function(Survey,years,quarter){
      listSurveys<-c("NS-IBTS","SWC-IBTS","SCOWCGFS","SCOROC","ROCKALL","NIGFS","IE-IGFS","SP-PORC","FR-CGFS","EVHOE","SP-NORTH","PT-IBTS","SP-ARSA")

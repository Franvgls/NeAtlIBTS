...
#' @examples gearPlotsHH.2("SWC-IBTS",c(2014:2016),1,.2)
#' @examples gearPlotsHH.2("SWC-IBTS",c(2013:2016),4,.2)
#' @examples gearPlotsHH.2("ROCKALL",c(2013:2016),3,.8)
#' @examples gearPlotsHH.2("NIGFS",c(2005:2016),1,.2)
#' @examples gearPlotsHH.2("NIGFS",c(2006:2007,2009:2016),4,.8)
#' @examples gearPlotsHH.2("IE-IGFS",c(2005:2016),4,.8)
#' @examples gearPlotsHH.2("SP-PORC",c(2003:2016),3,.5)
#' @examples gearPlotsHH.2("FR-CGFS",c(1998:2016),4,.8)
#' @examples gearPlotsHH.2("EVHOE",c(1997:2015),4,.9)
#' @examples gearPlotsHH.2("SP-NORTH",c(2014:2016),4,.3)
#' @examples gearPlotsHH.2("SP-ARSA",c(2014:2016),1.2)
#' @examples gearPlotsHH.2("SP-ARSA",c(2014:2016),4,.2)
#' @export
gearPlotsHH.2<-function(Survey,years,quarter,c.int=.8) {
   require(icesDatras)                                         
   ...
   if (length(subset(dumb$WingSpread,dumb$WingSpread> c(-9)))>0){
         ...
         if (length(levels(dumb$sweeplngt))==1) {
            ...
            points(WingSpread~Depth,dumb,subset=Year==years[length(years)],pch=21,bg="yellow")
         ...
         if (length(levels(dumb$sweeplngt))==2) {
            ...
            points(WingSpread~Depth,dumbshort,subset=HaulVal=="V",pch=21,col="orange")
            points(WingSpread~Depth,dumbshort,subset=Year==years[length(years)],pch=21,bg="orange")
            points(WingSpread~Depth,dumblong,subset=HaulVal=="V",pch=21,col="red")
            points(WingSpread~Depth,dumblong,subset=Year==years[length(years)],pch=21,bg="red")

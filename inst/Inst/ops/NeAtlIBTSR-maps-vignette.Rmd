...
```{r General Maps, fig.cap="Areas covered by the different surveys in IBTSWG",fig.width=10.1,fig.height=5.1,include=TRUE,results='hide'}
par(mfrow=c(1,2))
...
```{r Maps-Survey,fig.cap="Hauls in SCOWGCFS and IE-IGFS IBTS surveys in 2023 4th Quarter" ,fig.width=10.1,fig.height=5.1,include=TRUE,results='hide'}
par(mfrow=c(1,2))
